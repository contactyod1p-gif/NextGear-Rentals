...
const VEHICLES = [
  {
    ...
    accent: "#60a5fa",
    emoji: "🏆",
    perks: ["Leather Seats", "Sunroof", "Sport Mode"],
  },
  {
    ...
    accent: "#facc15",
    emoji: "🏔️",
    perks: ["4x4 Drive", "Convertible Top", "Off-Road Ready"],
  },
  {
    ...
    accent: "#34d399",
    emoji: "⚡",
    perks: ["Fuel Efficient", "Infotainment", "AC"],
  },
  {
    ...
    accent: "#a78bfa",
    emoji: "✨",
    perks: ["Sunroof", "6 Airbags", "Wireless Charging"],
  },
];
